      ...
      <AnimatePresence mode="wait">
        ...
        >
          {typeof currentLogo === "string" ? (
            ...
            React.createElement(currentLogo, {
              className:
...
function LogoCarousel({ columnCount = 2 }) {
  ...
  const allLogos = useMemo(
    () => [
      { name: "Apple", id: 1, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756883174/CTSH-82a8444b_s0dbpx.png" },
      { name: "CEO Supabase", id: 2, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756883175/infosys-limited-vector-logo-11574259008tncnrnxj7c_yalnls.png" },
      { name: "Vercel", id: 3, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756883174/4173356-middle_j0eroa.png" },
      { name: "Lowes", id: 4, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756883174/TCS_wordmark_2020_coekk1.webp" },
      { name: "Ally", id: 5, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756883174/IBM_logo.svg_kwf6kt.png" },
      { name: "Pierre", id: 6, img: "https://res.cloudinary.com/dubeuisom/image/upload/v1756889955/images_wr4goa.png" },
...
function OpenAIIconBlack(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="256"
